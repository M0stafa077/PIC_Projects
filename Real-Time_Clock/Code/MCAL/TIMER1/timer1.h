...
typedef struct
{
    ...
    /**
     * -> TMR1_INTERRUPT_HANDLER : A pointer to the ISR for timer1.
     */
    interrupt_handler_t TMR1_INTERRUPT_HANDLER;
#if INTERRUPT_PRIORITY_FEATURE==INTERRUPT_ENABLE
    /**
     * -> priority : The priority of the timer1 interrupt.
