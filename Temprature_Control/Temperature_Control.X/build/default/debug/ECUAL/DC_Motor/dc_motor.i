...
# 1 "ECUAL/DC_Motor/dc_motor_cfg.h" 1
...
# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libararies.h" 1
# 12 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libararies.h"
...
# 12 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libararies.h" 2
...
# 13 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libararies.h" 2
...
# 14 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libararies.h" 2
...
# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/gpio_cfg.h" 1
# 13 "ECUAL/DC_Motor/../../MCAL/GPIO/gpio.h" 2

# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/../device_config.h" 1
# 20 "ECUAL/DC_Motor/../../MCAL/GPIO/../device_config.h"
...
# 35 "ECUAL/DC_Motor/../../MCAL/GPIO/gpio.h"
typedef enum{
    GPIO_LOW = 0x00,
    GPIO_HIGH = 0x01
} logic_t;
...
# 8 "ECUAL/DC_Motor/dc_motor.c" 2


Std_ReturnType dc_motor_init(const dc_motor_t *_dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if((((void*)0) == _dc_motor) || ((_dc_motor->motor_pin)->pin) > 8 - 1
                           || ((_dc_motor->motor_pin)->port) > 5 - 1){
        ret = (Std_ReturnType)0x01U;
    }else{
        ret = gpio_pin_initialize(&(_dc_motor->motor_pin[0x00U]));
        ret = gpio_pin_initialize(&(_dc_motor->motor_pin[0x01U]));
    }
    return ret;
}
Std_ReturnType dc_motor_move_CW(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        ret = gpio_pin_write_logic(&(_dc_motor->motor_pin[0x00U]), GPIO_HIGH);
        ret = gpio_pin_write_logic(&(_dc_motor->motor_pin[0x01U]), GPIO_LOW);
    }
    return ret;
}
Std_ReturnType dc_motor_move_CCW(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        ret = gpio_pin_write_logic(&(_dc_motor->motor_pin[0x00U]), GPIO_LOW);
        ret = gpio_pin_write_logic(&(_dc_motor->motor_pin[0x01U]), GPIO_HIGH);
    }
    return ret;
}
Std_ReturnType dc_motor_stop(const dc_motor_t *_dc_motor){
