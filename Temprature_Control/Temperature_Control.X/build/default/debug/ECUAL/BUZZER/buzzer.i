...
# 1 "ECUAL/BUZZER/../../MCAL/GPIO/../std_libararies.h" 1
# 12 "ECUAL/BUZZER/../../MCAL/GPIO/../std_libararies.h"
...
# 12 "ECUAL/BUZZER/../../MCAL/GPIO/../std_libararies.h" 2
...
# 13 "ECUAL/BUZZER/../../MCAL/GPIO/../std_libararies.h" 2
...
# 14 "ECUAL/BUZZER/../../MCAL/GPIO/../std_libararies.h" 2
...
# 1 "ECUAL/BUZZER/../../MCAL/GPIO/gpio_cfg.h" 1
# 13 "ECUAL/BUZZER/../../MCAL/GPIO/gpio.h" 2

# 1 "ECUAL/BUZZER/../../MCAL/GPIO/../device_config.h" 1
# 20 "ECUAL/BUZZER/../../MCAL/GPIO/../device_config.h"
...
# 14 "ECUAL/BUZZER/../../MCAL/GPIO/gpio.h" 2
# 35 "ECUAL/BUZZER/../../MCAL/GPIO/gpio.h"
typedef enum{
    GPIO_LOW = 0x00,
    GPIO_HIGH = 0x01
} logic_t;
...
Std_ReturnType buzzer_turn_on(const Buzzer_t *_buzzer)
{
    ...
    {
        ret = gpio_pin_write_logic(&(_buzzer->buzzer_pin), 0x01U);
    }
    return ret;
}
...
Std_ReturnType buzzer_turn_off(const Buzzer_t *_buzzer)
{
    ...
    {
        ret = gpio_pin_write_logic(&(_buzzer->buzzer_pin), 0x00U);
    }
    return ret;
}
