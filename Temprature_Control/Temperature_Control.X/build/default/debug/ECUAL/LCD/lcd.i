...
# 1 "ECUAL/LCD/../../MCAL/GPIO/../std_libararies.h" 1
# 12 "ECUAL/LCD/../../MCAL/GPIO/../std_libararies.h"
...
# 12 "ECUAL/LCD/../../MCAL/GPIO/../std_libararies.h" 2
...
# 13 "ECUAL/LCD/../../MCAL/GPIO/../std_libararies.h" 2
...
# 14 "ECUAL/LCD/../../MCAL/GPIO/../std_libararies.h" 2
...
# 1 "ECUAL/LCD/../../MCAL/GPIO/gpio_cfg.h" 1
...
Std_ReturnType lcd_4bit_initialize(const char_lcd_4bit_t* _lcd){
    ...
    uint8_t l_data_pins_counter = 0x00U;
    if(((void*)0) == _lcd){
        ...
        for( ;l_data_pins_counter < 4; ++l_data_pins_counter){
...
Std_ReturnType lcd_4bit_send_command(const char_lcd_4bit_t* _lcd, uint8_t command){
    ...
    if(((void*)0) == _lcd){
        ...
        ret = gpio_pin_write_logic(&(_lcd->lcd_rs_pin), GPIO_LOW);
...
Std_ReturnType lcd_4bit_send_char_data(const char_lcd_4bit_t* _lcd, uint8_t data){
    ...
    if(((void*)0) == _lcd){
        ...
        ret = gpio_pin_write_logic(&(_lcd->lcd_rs_pin), GPIO_HIGH);
...
Std_ReturnType lcd_8bit_initialize(const char_lcd_4bit_t* _lcd){
    ...
    if(((void*)0) == _lcd){
        ...
        ret = gpio_pin_initialize(&(_lcd->lcd_rs_pin));
        ret = gpio_pin_initialize(&(_lcd->lcd_en_pin));
        for( ;l_data_pins_counter < 8; ++l_data_pins_counter){
            ret = gpio_pin_initialize(&(_lcd->lcd_data_pins[l_data_pins_counter]));
        }
        _delay((unsigned long)((20)*(8000000/4000.0)));
...
Std_ReturnType lcd_8bit_send_command(const char_lcd_4bit_t* _lcd, uint8_t command){
    Std_ReturnType ret =(Std_ReturnType)0x00U;
    uint8_t l_pin_counter = 0x00U;
    if(((void*)0) == _lcd){
        ret = (Std_ReturnType)0x01U;
    }
    else {
        ret = gpio_pin_write_logic(&(_lcd->lcd_rs_pin), GPIO_LOW);
        for( ; l_pin_counter < 8; ++l_pin_counter){
