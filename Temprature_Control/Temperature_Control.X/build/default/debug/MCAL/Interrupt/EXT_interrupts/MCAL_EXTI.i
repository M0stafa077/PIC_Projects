# 1 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c" 2
...
# 1 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.h"
# 1 "MCAL/Interrupt/EXT_interrupts/../MCAL_interrupt_cfg.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/../MCAL_interrupt_cfg.h"
# 1 "MCAL/Interrupt/EXT_interrupts/../../compiler.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/../../compiler.h"
...
# 12 "MCAL/Interrupt/EXT_interrupts/../../compiler.h" 2
# 12 "MCAL/Interrupt/EXT_interrupts/../MCAL_interrupt_cfg.h" 2

# 1 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h"
# 1 "MCAL/Interrupt/EXT_interrupts/../../GPIO/../MCAL_std_types.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/../../GPIO/../MCAL_std_types.h"
# 1 "MCAL/Interrupt/EXT_interrupts/../../std_libararies.h" 1
# 12 "MCAL/Interrupt/EXT_interrupts/../../std_libararies.h"
...
# 12 "MCAL/Interrupt/EXT_interrupts/../../std_libararies.h" 2
...
# 14 "MCAL/Interrupt/EXT_interrupts/../../std_libararies.h" 2
# 12 "MCAL/Interrupt/EXT_interrupts/../../GPIO/../MCAL_std_types.h" 2
...
# 12 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h" 2

# 1 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio_cfg.h" 1
# 13 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h" 2

# 1 "MCAL/Interrupt/EXT_interrupts/../../GPIO/../device_config.h" 1
# 20 "MCAL/Interrupt/EXT_interrupts/../../GPIO/../device_config.h"
...
# 14 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h" 2
# 35 "MCAL/Interrupt/EXT_interrupts/../../GPIO/gpio.h"
typedef enum{
    GPIO_LOW = 0x00,
    GPIO_HIGH = 0x01
} logic_t;
...
# 13 "MCAL/Interrupt/EXT_interrupts/../MCAL_interrupt_cfg.h" 2
# 48 "MCAL/Interrupt/EXT_interrupts/../MCAL_interrupt_cfg.h"
...
# 12 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.h" 2
# 74 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.h"
typedef enum {
...
# 9 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c" 2



static interrupt_handler_t INT0_INTERRUPT_HANDLER = ((void*)0);
static interrupt_handler_t INT1_INTERRUPT_HANDLER = ((void*)0);
static interrupt_handler_t INT2_INTERRUPT_HANDLER = ((void*)0);

static interrupt_handler_t RB4_INTERRUPT_HIGH_HANDLER = ((void*)0);
static interrupt_handler_t RB4_INTERRUPT_LOW_HANDLER = ((void*)0);
static interrupt_handler_t RB5_INTERRUPT_HIGH_HANDLER = ((void*)0);
static interrupt_handler_t RB5_INTERRUPT_LOW_HANDLER = ((void*)0);
static interrupt_handler_t RB6_INTERRUPT_HIGH_HANDLER = ((void*)0);
static interrupt_handler_t RB6_INTERRUPT_LOW_HANDLER = ((void*)0);
static interrupt_handler_t RB7_INTERRUPT_HIGH_HANDLER = ((void*)0);
static interrupt_handler_t RB7_INTERRUPT_LOW_HANDLER = ((void*)0);
...
# 55 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
Std_ReturnType EXTI_INTx_init(const EXTI_INTx_t* int_obj)
{
...
# 103 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
Std_ReturnType EXTI_INTx_deInit(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 124 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
Std_ReturnType EXTI_RBx_init(const EXTI_RBx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
    ...
    else
    {
        ...
        (INTCONbits.RBIE = 0x01U);
    }
    return ret;
}
# 166 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
Std_ReturnType EXTI_RBx_deInit(const EXTI_RBx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 293 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_enable(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
    ...
    else
    {
        ...
        {
            case EXTI_INT0:
                (INTCONbits.GIEH = 0x01U);
                (INTCONbits.GIEL = 0x01U);
                (INTCONbits.INT0IE = 0x01U);
                break;
            case EXTI_INT1:
                (INTCONbits.GIEH = 0x01U);
                (INTCONbits.GIEL = 0x01U);
                (INTCON3bits.INT1IE = 0x01U);
                break;
            case EXTI_INT2:
                (INTCONbits.GIEH = 0x01U);
                (INTCONbits.GIEL = 0x01U);
                (INTCON3bits.INT2IE = 0x01U);
                break;
            default:
                ret = (Std_ReturnType)0x01U;
                break;
...
# 335 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_disable(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
    ...
    else
    {
        ...
        {
            case EXTI_INT0:
                (INTCONbits.INT0IE = 0x00U);
                break;
            case EXTI_INT1:
                (INTCON3bits.INT1IE = 0x00U);
                break;
            case EXTI_INT2:
                (INTCON3bits.INT2IE = 0x00U);
                break;
            default:
                break;
        }
...
# 370 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_priority_init(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
            ...
            case EXTI_INT1:
                switch(int_obj->priority)
                {
                    case PRIORITY_HIGH:
                        (RCONbits.IPEN = 0x01U);
                        (INTCONbits.GIEH = 0x01U);
                        (INTCON3bits.INT1IP = PRIORITY_HIGH);
                        break;
                    case PRIORITY_LOW:
                        (RCONbits.IPEN = 0x01U);
                        (INTCONbits.GIEL = 0x01U);
                        (INTCON3bits.INT1IP = PRIORITY_LOW);
                        break;
                    default:
                        ret = (Std_ReturnType)0x01U;
                        break;
            ...
            case EXTI_INT2:
                switch(int_obj->priority)
                {
                    case PRIORITY_HIGH:
                        (RCONbits.IPEN = 0x01U);
                        (INTCONbits.GIEH = 0x01U);
                        (INTCON3bits.INT2IP = PRIORITY_HIGH);
                        break;
                    case PRIORITY_LOW:
                        (RCONbits.IPEN = 0x01U);
                        (INTCONbits.GIEL = 0x01U);
                        (INTCON3bits.INT2IP = PRIORITY_LOW);
                        break;
                    default:
                        ret = (Std_ReturnType)0x01U;
                        break;
...
# 437 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_edge_init(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
    ...
    else
    {
        switch(int_obj->src)
        {
            case EXTI_INT0:
                switch(int_obj->edge)
                {
                    case INTERRUPT_RISING_EDGE:
                        (INTCON2bits.INTEDG0 = 0x01U);
                        break;
                    case INTERRUPT_FALLING_EDGE:
                        (INTCON2bits.INTEDG0 = 0x00U);
                        break;
                    default:
                        ret = (Std_ReturnType)0x01U;
                        break;
            ...
            case EXTI_INT1:
                ...
                {
                    case INTERRUPT_RISING_EDGE:
                        (INTCON2bits.INTEDG1 = 0x01U);
                        break;
                    case INTERRUPT_FALLING_EDGE:
                        (INTCON2bits.INTEDG1 = 0x00U);
                        break;
                    default:
                        ret = (Std_ReturnType)0x01U;
                        break;
            ...
            case EXTI_INT2:
                ...
                {
                    case INTERRUPT_RISING_EDGE:
                        (INTCON2bits.INTEDG2 = 0x01U);
                        break;
                    case INTERRUPT_FALLING_EDGE:
                        (INTCON2bits.INTEDG2 = 0x00U);
                        break;
                    default:
                        ret = (Std_ReturnType)0x01U;
                        break;
...
# 505 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_pin_init(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 526 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_clear_flag(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 561 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INT0_setInterruptHandler(void (*EXTI_handler)(void))
{
    Std_ReturnType ret = (Std_ReturnType)0x01U;
    if(((void*)0) == EXTI_handler)
    {
        ret = (Std_ReturnType)0x01U;
    }
    else
...
# 582 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INT1_setInterruptHandler(void (*EXTI_handler)(void))
{
    Std_ReturnType ret = (Std_ReturnType)0x01U;
    if(((void*)0) == EXTI_handler)
...
# 603 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INT2_setInterruptHandler(void (*EXTI_handler)(void))
{
    Std_ReturnType ret = (Std_ReturnType)0x01U;
    if(((void*)0) == EXTI_handler)
...
# 624 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_INTx_setInterruptHandler(const EXTI_INTx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 660 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_RBx_priority_init(const EXTI_RBx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
    ...
    else
    {
        switch(int_obj->priority)
        {
            case PRIORITY_HIGH:
                (RCONbits.IPEN = 0x01U);
                (INTCONbits.GIEH = 0x01U);
                (INTCON2bits.RBIP = PRIORITY_HIGH);
                break;
            case PRIORITY_LOW:
                (RCONbits.IPEN = 0x01U);
                (INTCONbits.GIEL = 0x01U);
                (INTCON2bits.RBIP = PRIORITY_LOW);
                break;
            default:
                ret = (Std_ReturnType)0x01U;
                break;
...
# 696 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_RBx_pin_init(const EXTI_RBx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == int_obj)
...
# 717 "MCAL/Interrupt/EXT_interrupts/MCAL_EXTI.c"
static Std_ReturnType EXTI_RBx_setInterruptHandler(const EXTI_RBx_t* int_obj)
{
    Std_ReturnType ret = (Std_ReturnType)0x01U;
    if(((void*)0) == int_obj)
