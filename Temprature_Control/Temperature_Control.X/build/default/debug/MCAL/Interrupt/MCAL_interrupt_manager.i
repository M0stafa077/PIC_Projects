...
# 12 "MCAL/Interrupt/MCAL_interrupt_cfg.h"
...
# 12 "MCAL/Interrupt/MCAL_interrupt_cfg.h" 2

# 1 "MCAL/Interrupt/../GPIO/gpio.h" 1
# 12 "MCAL/Interrupt/../GPIO/gpio.h"
# 1 "MCAL/Interrupt/../GPIO/../MCAL_std_types.h" 1
# 12 "MCAL/Interrupt/../GPIO/../MCAL_std_types.h"
# 1 "MCAL/Interrupt/../std_libararies.h" 1
# 12 "MCAL/Interrupt/../std_libararies.h"
...
# 12 "MCAL/Interrupt/../std_libararies.h" 2
...
# 14 "MCAL/Interrupt/../std_libararies.h" 2
# 12 "MCAL/Interrupt/../GPIO/../MCAL_std_types.h" 2
...
# 12 "MCAL/Interrupt/../GPIO/gpio.h" 2

# 1 "MCAL/Interrupt/../GPIO/gpio_cfg.h" 1
# 13 "MCAL/Interrupt/../GPIO/gpio.h" 2

# 1 "MCAL/Interrupt/../GPIO/../device_config.h" 1
# 20 "MCAL/Interrupt/../GPIO/../device_config.h"
...
# 13 "MCAL/Interrupt/MCAL_interrupt_cfg.h" 2
# 48 "MCAL/Interrupt/MCAL_interrupt_cfg.h"
...
# 22 "MCAL/Interrupt/MCAL_interrupt_manager.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
...
{
    if((0x01U == INTCONbits.INT0IE) && (0x01U == INTCONbits.INT0IF))
    {
        INT0_ISR();
    }
    else
    ...
    if((0x01U == INTCON3bits.INT1IE) && (0x01U == INTCON3bits.INT1IF))
    {
        INT1_ISR();
    }
    else
    ...
    if((0x01U == INTCONbits.RBIE) && (0x01U == INTCONbits.RBIF)
                                             && (PORTBbits.RB4 == 0x01U))
    {
        RB4_ISR(0x01U);
    }
                                             ...
                                             && (PORTBbits.RB4 == 0x00U))
    {
        ...
        { }
    if ( (0x01U == PIE1bits.ADIE) && (0x01U == PIR1bits.ADIF) )
    {
        INTI_ADC_ISR();
    }
    else
...
{
    if((0x01U == INTCON3bits.INT2IE) && (0x01U == INTCON3bits.INT2IF))
    {
        INT2_ISR();
    }
    else
