...
# 1 "MCAL/GPIO/../std_libararies.h" 1
# 12 "MCAL/GPIO/../std_libararies.h"
...
# 12 "MCAL/GPIO/../std_libararies.h" 2
...
# 13 "MCAL/GPIO/../std_libararies.h" 2
...
# 14 "MCAL/GPIO/../std_libararies.h" 2
...
# 1 "MCAL/GPIO/gpio_cfg.h" 1
# 13 "MCAL/GPIO/gpio.h" 2

# 1 "MCAL/GPIO/../device_config.h" 1
# 20 "MCAL/GPIO/../device_config.h"
    ...
    if(((void*)0) == _pin_config || _pin_config -> pin > 8 - 1){
        ...
        switch(_pin_config -> direction){
            case GPIO_DIRECTION_OUTPUT:
                *tris_registers[_pin_config -> port] &= ~((uint8_t)0x01 << _pin_config -> pin);
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t* _pin_config, direction_t *dir_status){
    ...
    if(((void*)0) == _pin_config || (_pin_config -> pin) > 8 - 1){
        ...
        *dir_status = ((*tris_registers[_pin_config -> port] >> _pin_config -> pin) & (uint8_t)0x01);
    }
    return ret;
}
# 84 "MCAL/GPIO/gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t* _pin_config, logic_t logic){
    ...
    if(((void*)0) == _pin_config || (_pin_config -> pin) > 8 - 1){
        ...
        switch(logic){
            case 0x01U:
                *lat_registers[_pin_config -> port] |= ((uint8_t)0x01 << _pin_config -> pin);
                break;
            case 0x00U:
                *lat_registers[_pin_config -> port] &= ~((uint8_t)0x01 << _pin_config -> pin);
                break;
            default: ret = (Std_ReturnType)0x01U;
        }
    }
    return ret;
}
# 115 "MCAL/GPIO/gpio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t* _pin_config, uint8_t *logic){
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == _pin_config || _pin_config -> pin > 8 - 1 || ((void*)0) == logic){
        ret = (Std_ReturnType)0x01U;
    } else{
        *logic = ((*port_registers[_pin_config -> port] >> _pin_config -> pin) & (uint8_t)0x01);
    }
    return ret;
}
# 135 "MCAL/GPIO/gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t* _pin_config){
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if(((void*)0) == _pin_config || (_pin_config -> pin) > 8 - 1 ){
        ret = (Std_ReturnType)0x01U;
...
# 247 "MCAL/GPIO/gpio.c"
Std_ReturnType gpio_port_read_logic(const port_index_t port, uint8_t *value){
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if((port > 5 - 1 )|| (((void*)0) == value) ){
        ret = (Std_ReturnType)0x01U;
    }
    else {
