...
# 12 "MCAL/ADC/../GPIO/../std_libararies.h" 2
...
# 13 "MCAL/ADC/../GPIO/../std_libararies.h" 2
...
# 14 "MCAL/ADC/../GPIO/../std_libararies.h" 2
...
# 1 "MCAL/ADC/../GPIO/gpio_cfg.h" 1
# 13 "MCAL/ADC/../GPIO/gpio.h" 2

# 1 "MCAL/ADC/../GPIO/../device_config.h" 1
# 20 "MCAL/ADC/../GPIO/../device_config.h"
...
# 13 "MCAL/ADC/hal_adc.h" 2

# 1 "MCAL/ADC/../Interrupt/INT_interrupts/MCAL_INTI.h" 1
# 12 "MCAL/ADC/../Interrupt/INT_interrupts/MCAL_INTI.h"
# 1 "MCAL/ADC/../Interrupt/INT_interrupts/../MCAL_interrupt_cfg.h" 1
# 48 "MCAL/ADC/../Interrupt/INT_interrupts/../MCAL_interrupt_cfg.h"
...
# 12 "MCAL/ADC/../Interrupt/INT_interrupts/MCAL_INTI.h" 2
# 14 "MCAL/ADC/hal_adc.h" 2
# 157 "MCAL/ADC/hal_adc.h"
typedef enum
{
...
static interrupt_handler_t ADC_interrupt_handler = ((void*)0);
...
Std_ReturnType ADC_init(const adc_cfg_t *_adc)
{
    ...
    else
    {
        ...
        (ADCON0bits.ADON = 0x01U);
    }
    return ret;
}
# 86 "MCAL/ADC/hal_adc.c"
Std_ReturnType ADC_deInit(const adc_cfg_t *_adc)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if (((void*)0) == _adc)
...
Std_ReturnType ADC_start_conversion(const adc_cfg_t *_adc)
{
    ...
    {
        (ADCON0bits.GODONE = 0x01U);
    }
    return ret;
}
# 163 "MCAL/ADC/hal_adc.c"
Std_ReturnType ADC_is_conversion_done(const adc_cfg_t *_adc, uint8_t* status)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if ((((void*)0) == _adc) || (((void*)0) == status))
    {
        ret = (Std_ReturnType)0x01U;
    }
    else
    {
        ...
        if (0x01U == (ADCON0bits.GO_nDONE))
        {
            *status = 0x00U;
        }
        else if (0x00U == (ADCON0bits.GO_nDONE))
        {
            *status = 0x01U;
        }
        else
...
# 196 "MCAL/ADC/hal_adc.c"
Std_ReturnType ADC_get_conversion_result(const adc_cfg_t *_adc, adc_result_t *result)
{
    Std_ReturnType ret = (Std_ReturnType)0x00U;
    if (((void*)0) == _adc || ((void*)0) == result)
    {
        ret = (Std_ReturnType)0x01U;
    }
    else
...
# 283 "MCAL/ADC/hal_adc.c"
static void adc_input_channel_port_cfg(const adc_cfg_t *_adc)
{
    switch (_adc->adc_channel)
    {
        case ADC_CHANNEL_AN0 : TRISA |= ((uint8_t)0x01 << 0x0);
                            break;
        case ADC_CHANNEL_AN1 : TRISA |= ((uint8_t)0x01 << 0x1);
                            break;
        case ADC_CHANNEL_AN2 : TRISA |= ((uint8_t)0x01 << 0x2);
                            break;
        case ADC_CHANNEL_AN3 : TRISA |= ((uint8_t)0x01 << 0x3);
                            break;
        case ADC_CHANNEL_AN4 : TRISA |= ((uint8_t)0x01 << 0x5);
                            break;
        case ADC_CHANNEL_AN5 : TRISE |= ((uint8_t)0x01 << 0x0);
                            break;
        case ADC_CHANNEL_AN6 : TRISE |= ((uint8_t)0x01 << 0x1);
                            break;
        case ADC_CHANNEL_AN7 : TRISE |= ((uint8_t)0x01 << 0x2);
                            break;
        case ADC_CHANNEL_AN8 : TRISB |= ((uint8_t)0x01 << 0x2);
                            break;
        case ADC_CHANNEL_AN9 : TRISB |= ((uint8_t)0x01 << 0x3);
                            break;
        case ADC_CHANNEL_AN10 : TRISB |= ((uint8_t)0x01 << 0x1);
                            break;
        case ADC_CHANNEL_AN11 : TRISB |= ((uint8_t)0x01 << 0x4);
                            break;
        case ADC_CHANNEL_AN12 : TRISB |= ((uint8_t)0x01 << 0x0);
                            break;
    }
}
...
static void adc_set_result_format(const adc_cfg_t *_adc)
{
    switch (_adc->result_format)
    {
        case 0x01U : (ADCON2bits.ADFM = 0x01U);
                            break;
        case 0x00U : (ADCON2bits.ADFM = 0x00U);
                            break;
        default : (ADCON2bits.ADFM = 0x01U);
              break;
    }
}
...
static void adc_set_voltage_ref(const adc_cfg_t *_adc)
{
    ...
    {
        case 0x01U : do{ADCON1bits.VCFG1 = 0x01U; ADCON1bits.VCFG0 = 0x01U; }while(0x00U);
                                        break;
        case 0x00U : do{ADCON1bits.VCFG1 = 0x00U; ADCON1bits.VCFG0 = 0x00U; }while(0x00U);
                                        break;
        default : do{ADCON1bits.VCFG1 = 0x00U; ADCON1bits.VCFG0 = 0x00U; }while(0x00U);
              break;
    }
}
